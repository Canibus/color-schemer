export class I18nManager {
  ...
  private translations: Record<string, Record<string, string>> = {
    en: {
      ...
      "settings.hardware": "HARDWARE INFO",
      "settings.gpu": "GPU",
      "settings.nvapi_status": "NVAPI STATUS",
      "settings.status_ok": "Active (NVIDIA)",
      "settings.status_mock": "MOCK MODE (NO NVIDIA GPU)",
      "settings.maintenance": "MAINTENANCE",
      "settings.reset_defaults": "RESET TO FACTORY DEFAULTS",
      "settings.confirm_reset": "Are you sure? This will delete all your profiles and settings.",
      ...
      "app.status.resetting": "Resetting...",
    ...
    ru: {
      ...
      "settings.hardware": "ИНФОРМАЦИЯ ОБ ОБОРУДОВАНИИ",
      "settings.gpu": "GPU",
      "settings.nvapi_status": "СТАТУС NVAPI",
      "settings.status_ok": "Активен (NVIDIA)",
      "settings.status_mock": "РЕЖИМ ЭМУЛЯЦИИ (GPU НЕ НАЙДЕН)",
      "settings.maintenance": "ОБСЛУЖИВАНИЕ",
      "settings.reset_defaults": "СБРОС К ЗАВОДСКИМ НАСТРОЙКАМ",
      "settings.confirm_reset": "Вы уверены? Это удалит все ваши профили и настройки.",
